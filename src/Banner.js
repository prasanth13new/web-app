...
function Banner() {
  return (
    ...
    <div className='banner'>
        ...
        <Button style={{"margin-left": "250px", "text-transform": "capitalize", color:"white" }} color="inherit" variant="outlined" size="small">Lets talk😄</Button>                   
        </div>

        <div className="animation">
          <img src="https://static.bluelabellabs.com/wp-content/uploads/2021/10/bll-small-logo.png" alt="animation" />
        </div>
        </div>
        ...
        <div className="logos">
          ...
          {/* <img src="https://www.vhv.rs/dpng/d/535-5351764_clutch-co-logo-hd-png-download.png" alt="img" className="img" /> */}
